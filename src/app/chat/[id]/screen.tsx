...
export default function Screen(
    ...
    return (
        <div className="h-screen flex flex-col">
            <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-border/50 h-14 flex items-center px-4 shrink-0 shadow-sm">
                <div className="flex items-center gap-2">
                    <Button variant="ghost" size="default" onClick={() => setIsLeftSidebarOpen(!isLeftSidebarOpen)}>
                        <Menu className="w-4 h-4"/>
                    </Button>
                    <h1 className="text-lg font-semibold">{tc('openHealth')}</h1>
                </div>
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* Left sidebar */}
                {isLeftSidebarOpen && (
                    <div className="w-72 border-r border-border/50 bg-muted/30 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 flex flex-col bg-background min-w-0">
                    ...
                    <div className="mb-16 md:mb-0">
                        ...
                        <div className="border-t border-border/50 p-4 z-10 md:static fixed bottom-0 left-0 w-full bg-background/80 backdrop-blur-md">
                ...
                {/* Right sidebar */}
                {isRightSidebarOpen && (
                    <div className="w-80 border-l border-border/50 bg-muted/30 flex flex-col overflow-y-auto">
            ...
            <Dialog open={isJsonViewerOpen} onOpenChange={setIsJsonViewerOpen}>
                <DialogContent className="max-w-2xl max-h-[80vh]">
                    <DialogHeader><DialogTitle>{tc('sourceData')}</DialogTitle></DialogHeader>
