        ...
        <>
            ...
            {showSettingsAlert && (
                <Dialog open={showSettingsAlert} onOpenChange={setShowSettingsAlert}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>{tc('settingsRequired')}</DialogTitle>
                        </DialogHeader>
                        <div className="space-y-4">
                            <p className="text-sm">{tc('settingsRequiredMessage')}</p>
                            <ul className="list-disc pl-4 text-sm space-y-2">
                                <li>{tc('settingsRequiredStep1')}</li>
                                <li>{tc('settingsRequiredStep2')}</li>
                            </ul>
                            <p className="text-sm">{tc('settingsRequiredHint')}</p>
                    ...
                    <div className="bg-white rounded-lg border h-full flex flex-col gap-4">
                        ...
                        {healthData?.type === HealthDataType.FILE.id && formData.parsingLogs && (
                            <div className="border-t">
                                <div className="p-4">
                                    <h3 className="text-sm font-medium mb-2">{tc('processingLog')}</h3>
                                    <div
